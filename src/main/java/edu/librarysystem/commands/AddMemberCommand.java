...
/**
 * The AddMemberCommand class implements the Command interface and
 * represents a command to add a new member to the library system.
 */
public class AddMemberCommand implements Command {
    ...
    /**
     * Constructs a new AddMemberCommand with the specified parameters.
     *
